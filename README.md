...
# 🏴 TryHackMe KoTH – My Arsenal 

This repository is my personal King of the Hill (KoTH) war chest. Over countless matches, I’ve collected scripts, notes, and sneaky little tricks that have helped me not only gain root, but also hold the throne against other players.

Think of this repo as both a reference and a training ground for my KoTH journey.

- ⚔️ What’s Inside
- ⚡ Custom scripts I rely on during KoTH matches
- 🔑 One-liners & privilege escalation tricks I’ve used in real games
- 🛠️ Notes on services, misconfigurations, and footholds I see often
- 📚 Tips for both attacking and defending once I’ve claimed the box
